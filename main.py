...
if __name__ == '__main__':
    ...
    application.add_handler(CommandHandler('ddia_on', admin_commands.ddia_notification_on))
    application.add_handler(CommandHandler('ddia_off', admin_commands.ddia_notification_off))
