...
mock_leetcode_reminder = ("Тема этой недели — {}."
                          "\n\nЗапишись сегодня, чтобы на выходных пройти leetcode мок-собеседование! "
                          "Завтра уже будут объявлены пары")

mock_leetcode_topic_announcement = \
    ("Тема этой недели — {}."
     "\n\nВыбери две задачи (основную и запасную), желательно уровня medium, и запишись в боте @neLenkin_bot командой"
     " /leetcode_register, сами встречи будут на +- выходных."
     "\n\nЕсли хочешь вспомнить формат мока, вот  <a href='https://youtu.be/XKu_SEDAykw?si=PGww6YoPzksz-_h6'>видео с демо</a> "
     "собеса из Google.")
...
mocks_enroll_description = "Бот будет присылать тебе тему неделю по понедельникам."
mocks_unenroll_description = "Бот больше не будет присылать тебе тему неделю для Leetcode моков."
...
leetcode_language_options = ['Русский', 'Английский']
