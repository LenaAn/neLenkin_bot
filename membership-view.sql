...
--
-- Name: Membership; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public."Membership" AS
 SELECT user_id,
    (CURRENT_DATE + ((count(*))::double precision * '105 days'::interval)) AS expiry_date
   FROM public."Contributions"
  GROUP BY user_id;


ALTER VIEW public."Membership" OWNER TO postgres;
