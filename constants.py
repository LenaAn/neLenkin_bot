...
mock_leetcode_description = \
    ("Прорешивать Leetcode — это хорошо, но на реальном собеседовании важно уметь рассказать ход решения, "
     ...
     "Подпишись, чтобы бот каждый понедельник присылал тебе тему недели и в каждый четверг напоминал "
     "зарегистрироваться, чтобы участвовать в мок-собеседовании в выходные.")
...
leetcode_enroll_description = \
    "Ура! Теперь я буду присылать тебе тему недели по понедельникам и напоминание записаться на моки по четвергам!"
