...
ALTER SEQUENCE public."Course_activity_id_seq" OWNER TO postgres;

--
-- Name: Course_activity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: Course_activity id; Type: DEFAULT; Schema: public; Owner: postgres
--
